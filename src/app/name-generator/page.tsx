...
<p className="text-[#5F5F5F] text-[12.5px] mt-0.5">(1,284)</p>
      ...
      />
        ...
        <div className="flex flex-col gap-3 md:flex-row b">
          <div>fsdfs</div>
...
const FancyTextContainer: React.FC<FancyTextContainerProps> = ({
  ...
  return (
     <div  onClick={handleCopy} className="copy-container items-center dark:text-white cursor-pointer flex justify-between bg-transparent  border-[#dfdfdf] border-b py-3 pr-3 pl-1 rounded w-full">
      ...
      <div>
        ...
        >
 {isCopied ? (
        <div className="copied-message text-white">
          Copied!
        </div>
      ) : (
        <button
